...
public class Page {
  ...
  if(title8.equals("OrangeHRM - New Level of HR Management"))
	  System.out.println("successful verified title");
    ...
    //assign username and password to strings
       ...
       //  Login to HRM
        ...
        // verify OrangeHRM title, else failed to login
         ...
         if(title6.equals("OrangeHRM - New Level of HR Management"))
      ...
      // get welcome text and store in a string
